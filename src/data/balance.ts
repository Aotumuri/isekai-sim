export const WORLD_BALANCE = {
  ...
  unit: {
    ...
    amphibiousAssault: {
      ...
      reactionShortWindowFraction: 0.35,
      reactionMediumWindowFraction: 1,
      reactionShortWeight: 0.75,
      reactionMediumWeight: 0.35,
      landingValue: {
        port: 30,
        capital: 75,
        strategicCity: 35,
        maritimeSupplySource: 45,
        weakDefense: 25,
        inlandExpansionPerRegion: 8,
        nearbyFriendlyObjective: 20,
      },
      landingRisk: {
        immediateDefenderPerStrength: 5,
        reactionPerStrength: 4,
