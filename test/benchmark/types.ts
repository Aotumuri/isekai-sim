...
export interface WorldSummary {
  ...
  warIntentAboveThreshold: number;
  warIntentDeclarations: number;
  warIntentDeclarationsOpportunistic: number;
  warIntentDeclarationsThreatResponse: number;
  warIntentDeclarationsStrategicPort: number;
  warIntentDeclarationsMaritimeExpansion: number;
  warIntentDeclarationsBalanceOfPower: number;
  warIntentDeclarationsWeakenedEnemy: number;
  warIntentSuppressed: number;
  warIntentSuppressedExternalThreat: number;
  warIntentSuppressedExistingWars: number;
  warIntentSuppressedCapitalEmergency: number;
  warIntentMaritimeDeclarations: number;
  warIntentAverage: number;
  warIntentAverageOpportunity: number;
  warIntentAverageThreat: number;
  warIntentAverageCost: number;
  warIntentAverageExternalExposure: number;
  warIntentRankingChanges: number;
  warIntentCpuMs: number;
  warIntentThirdPartyOpportunisticInvasions: number;
  warIntentWarsAgainstAlreadyFighting: number;
  warIntentMultiWarStarts: number;
  warIntentDeclarationsAgainstTopThreat: number;
  warIntentDeclarationsAgainstWeakerNonThreat: number;
