...
export function summarizeWorld(world: WorldState): WorldSummary {
  ...
  return {
    ...
    maritimeLinksEvaluated: world.supplyAssessment.maritimeLinksEvaluated,
    activeMaritimeLinks: world.supplyAssessment.activeMaritimeLinkCount,
    inactiveMaritimeLinks: world.supplyAssessment.inactiveMaritimeLinkCount,
    maritimeRemoteComponentsSupplied: world.supplyAssessment.remoteComponentsSupplied,
    maritimeRemoteComponentsIsolated: world.supplyAssessment.remoteComponentsIsolated,
    maritimeSupplyLossesDueToTransport: world.supplyAssessment.maritimeSupplyLossesDueToTransport,
    maritimeSupplyLossesDueToPortCapture: world.supplyAssessment.maritimeSupplyLossesDueToPortCapture,
    maritimeReconnections: world.supplyAssessment.maritimeReconnections,
    ...
    amphibiousOpportunities: world.amphibiousOperations.opportunities,
    amphibiousLandingPlans: world.amphibiousOperations.landingPlans,
    amphibiousCancelledPlans: world.amphibiousOperations.cancelledPlans,
    amphibiousCompletedLandings: world.amphibiousOperations.completedLandings,
    amphibiousEmbarkationDelayTicks: world.amphibiousOperations.embarkationDelayTicks,
    amphibiousTransportAssignments: world.amphibiousOperations.transportAssignments,
    amphibiousEscortWaitingTicks: world.amphibiousOperations.escortWaitingTicks,
    amphibiousConvoyTravelTicks: world.amphibiousOperations.convoyTravelTicks,
    ...
    supplyCutoffCandidatesEvaluated: world.supplyCutoffs.candidatesEvaluated,
    meaningfulSupplyCutoffCandidates: world.supplyCutoffs.meaningfulCandidates,
    supplyCutoffOperationsCreated: world.supplyCutoffs.operationsCreated,
    supplyCutoffAttacksLaunched: world.supplyCutoffs.attacksLaunched,
    supplyCutoffTargetCaptures: world.supplyCutoffs.targetCaptures,
    successfulSupplyCutoffs: world.supplyCutoffs.successfulCutoffs,
    failedSupplyCutoffs: world.supplyCutoffs.failedCutoffs,
    predictedSupplyCutoffStrength: world.supplyCutoffs.predictedIsolatedStrength,
    actualSupplyCutoffStrength: world.supplyCutoffs.actualIsolatedStrength,
    supplyCutoffIsolatedUnits: world.supplyCutoffs.isolatedUnits,
    supplyCutoffIsolatedRegions: world.supplyCutoffs.isolatedRegions,
    supplyCutoffIsolatedCities: world.supplyCutoffs.isolatedCities,
    supplyCutoffIsolatedPorts: world.supplyCutoffs.isolatedPorts,
    frontlineComponentsIsolated: world.supplyCutoffs.frontlineComponentsIsolated,
    averageCutoffToIsolationTicks: world.supplyCutoffs.cutoffToIsolationSamples > 0
      ? world.supplyCutoffs.cutoffToIsolationTicks / world.supplyCutoffs.cutoffToIsolationSamples : 0,
    averageSupplyIsolationDurationTicks: world.supplyCutoffs.successfulCutoffs > 0
      ? world.supplyCutoffs.isolationDurationTicks / world.supplyCutoffs.successfulCutoffs : 0,
    sustainedSupplyCutoffs: world.supplyCutoffs.sustainedCutoffs,
    supplyReconnections: world.supplyCutoffs.reconnections,
    averageSupplyCutoffTacticalScore: world.supplyCutoffs.scoreSamples > 0
      ? world.supplyCutoffs.tacticalScoreTotal / world.supplyCutoffs.scoreSamples : 0,
    averageSupplyCutoffScore: world.supplyCutoffs.scoreSamples > 0
      ? world.supplyCutoffs.supplyScoreTotal / world.supplyCutoffs.scoreSamples : 0,
    supplyCutoffToPocketReduction: world.supplyCutoffs.cutoffToPocketReduction,
    supplyCutoffToCollapseAdvance: world.supplyCutoffs.cutoffToCollapseAdvance,
    supplyCutoffToSurrender: world.supplyCutoffs.cutoffToSurrender,
